          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <a href="{{route('post.create')}}"><button class="btn btn-success" style="margin: 20px; float:right; width:200px;">Yangi qo'shish</button></a>
                <table class="table table-hover text-nowrap">
                  ...
                  @foreach($posts as $post)
                    <tr>
                      <td>{{$post->post_id}}</td>
                      <td><img src="images/{{$product->img}}" style="width: 50px;"></td>
